...
% ]{background}
%
% \backgroundsetup{contents={ZTE Confidential}}
...
%%自定义封面
\def\titlename{Robot Cleaner}
\def\subtitle{Programming in Modern C++11}
\def\authors{刘光聪}
\def\orgnization{GNU \textcopyright 2015}
...
\input{contents/sprint-1.tex}
\input{contents/sprint-2.tex}
\input{contents/sprint-3.tex}
\input{contents/sprint-4.tex}
\input{contents/sprint-5.tex}
\input{contents/sprint-6.tex}
\input{contents/sprint-7.tex}
